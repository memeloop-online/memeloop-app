...
describe('basicPromptConcatHandler - failure path persists error message and logs', () => {
  ...
  it.skip('should push error message with duration=1, persist it, and write external_api_logs error', async () => {
  ...
  it.skip('should cover two-round flow: tool_use then Chat.ConfigError.AIProviderError and print ordering', async () => {
