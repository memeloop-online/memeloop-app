...
async function bootWiki(
  ...
  // TiddlyWiki 5.4 startup can include asynchronous startup modules. Do not
  // expose the IPC routes until their callback fires: an early getIndex call
  // otherwise observes a half-initialized wiki whose methods are not loaded.
