...
/**
 * Plaintext, app-local credential storage. The owner of the local machine is
 * responsible for protecting this file; it deliberately does not use OS
 * keychain services or any database-backed credential migration.
 */
...
/** Lazily create the process-wide auth store without filesystem access at import time. */
