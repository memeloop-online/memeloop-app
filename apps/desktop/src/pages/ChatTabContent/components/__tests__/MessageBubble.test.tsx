...
describe('MessageBubble - Duration-based Graying', () => {
  ...
  it('should display message content without wiki tiddler attachments', () => {
    // Setup a message (wiki tiddler attachments feature removed in memeloop-desktop)
    ...
    // Check that the original message content is displayed (wiki tiddler chips removed)
