...
export const InputContainer: React.FC<InputContainerProps> = ({
  ...
  const handleAttachmentClick = (event: React.MouseEvent<HTMLElement>) => {
    ...
    void (async () => {
      try {
        // Build options: only "Add Image" (wiki tiddlers removed with wiki functionality)
        const options: Array<{ type: 'image'; title: string; testId?: string }> = [
          { type: 'image', title: t('Agent.Attachment.AddImage'), testId: 'AddImage' },
        ];
