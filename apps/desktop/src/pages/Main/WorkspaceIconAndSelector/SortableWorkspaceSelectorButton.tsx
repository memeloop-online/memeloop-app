...
import {
  ...
  type IWorkspaceMenuRequiredServices,
} from '@services/workspaces/getWorkspaceMenuTemplate';
...
export function SortableWorkspaceSelectorButton({ index, workspace, showSidebarTexts, showSideBarIcon }: ISortableItemProps): React.JSX.Element {
  ...
  const onWorkspaceContextMenu = useCallback(
    async (event: MouseEvent<HTMLDivElement>) => {
      ...
      const workspaceContextMenuTemplate = await getSimplifiedWorkspaceMenuTemplate(workspace, t, window.service as unknown as IWorkspaceMenuRequiredServices, {
