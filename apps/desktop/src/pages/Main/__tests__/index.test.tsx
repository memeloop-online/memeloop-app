...
describe('Main Page', () => {
  ...
  beforeEach(async () => {
    ...
    renderMain();
    // MemeLoop Desktop is agent-first when no workspace is active.
  ...
  it('should display Agent content and preferences button by default', async () => {
    expect(screen.getAllByTestId('agent-page')).toHaveLength(1);
