    ...
    <>
      ...
      <ListItem sx={{ alignItems: 'flex-start', flexDirection: 'column', gap: 1.5 }}>
        ...
        <Box sx={{ alignSelf: 'flex-end' }}>
          <Button size='small' startIcon={<AddIcon />} onClick={() => void createGroup()} data-testid='create-group-button'>
              ...
              <ListItem sx={{ alignItems: 'flex-start', flexDirection: 'column', gap: 1.5 }}>
                <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  {isEditing
                    ? (
                      <>
                        <IconButton size='small' onClick={() => void saveGroupName(group)} data-testid={`save-group-${group.id}`}>
                    ...
                    : (
                      <>
                        ...
                        <IconButton size='small' onClick={() => void deleteGroup(group)} data-testid={`delete-group-${group.id}`}>
                ...
                <Autocomplete
                  ...
                  onChange={(_event, newValue) => void syncGroupMembership(group.id, newValue)}
                />
              </ListItem>
            </Box>
          );
