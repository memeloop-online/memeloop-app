...
> **Deprecated:** Wiki/workspace functionality has been removed. The TiddlyWiki IPC sync adaptor and watch-filesystem adaptor architecture is no longer in use.
