...
This document describes the menu registration and context menu system in memeloop-desktop, including how right-click context menus and application menus are registered, how they are shared or separated, and the main extension points for workspace-related actions.

> **Note:** Wiki/workspace functionality has been removed. Workspace-related menu items are deprecated.
